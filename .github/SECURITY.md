...
| -------- | ------------------ | ----------------------------- |
| >= 3.x.x | :white_check_mark: | Next major version + 6 months |
| >= 2.x.x | :x:                | 2026-06-13                    |
| <= 1.x.x | :x:                | N/A                           |
...
1. **For non-critical issues**:
   [Open a new issue](https://github.com/P5-wrapper/next/issues/new) and select
...
[@p5-wrapper/next](https://github.com/P5-wrapper/next) secure!
