...
[issues](https://github.com/P5-wrapper/next/issues).
...
1. Check the [documentation](https://github.com/P5-wrapper/next#readme) first
2. Search for [existing issues](https://github.com/P5-wrapper/next/issues) that
   might address your question
3. If you can't find an answer, create
   [a new issue](https://github.com/P5-wrapper/next/issues/new) with the
   `question` tag
...
1. Check if it's already been reported in the
   [issues](https://github.com/P5-wrapper/next/issues)
2. If not, create [a new issue](https://github.com/P5-wrapper/next/issues/new)
   with the `bug` tag
...
[Code of Conduct](https://github.com/P5-wrapper/next/blob/master/.github/CODE_OF_CONDUCT.md).
